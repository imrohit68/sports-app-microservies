...
public class GlobalExceptions extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> fallBackException(FeignClientException ex){
        return new ResponseEntity<>(new ErrorResponse(ex.getMessage(),false),HttpStatus.SERVICE_UNAVAILABLE);
    }
}
